...
function checkConfigVersion2(fullConfig) {
  ...
  if (!datadirUndefined || addressDefined || dbDefined) {
    ...
    console.warn('\nConfiguration file is not compatible with this version. \n' +
                 'A reindex for dashd is necessary for this upgrade with the "reindex=1" unfy.conf option. \n' +
                 'There are changes necessary in both unfy.conf and dashcore-node.json. \n\n' +
